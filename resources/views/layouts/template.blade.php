...
<head>
	...
	<link href="assets2/plugins/sw-bootstrap/css/highlight.css" rel="stylesheet">
	<link href="assets2/plugins/sw-bootstrap/css/bootstrap3/bootstrap-switch.css" rel="stylesheet">
	<link href="assets2/plugins/prettify/prettify.min.css" rel="stylesheet">
	<link href="assets2/plugins/magnific-popup/magnific-popup.min.css" rel="stylesheet">
	<link href="assets2/plugins/chosen/chosen.min.css" rel="stylesheet">
	<link href="assets2/plugins/icheck/skins/all.css" rel="stylesheet">
	<link href="assets2/plugins/datepicker/datepicker.min.css" rel="stylesheet">
	<link href="assets2/plugins/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
	<link href="assets2/plugins/validator/bootstrapValidator.min.css" rel="stylesheet">
	<link href="assets2/plugins/summernote/summernote.min.css" rel="stylesheet">
	<link href="assets2/plugins/markdown/bootstrap-markdown.min.css" rel="stylesheet">
	<link href="assets2/plugins/datatable/css/bootstrap.datatable.min.css" rel="stylesheet">
	<link href="assets2/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet">
	<link href="assets2/plugins/fullcalendar/fullcalendar/fullcalendar.print.css" rel="stylesheet" media="print">
	...
	<link href="assets2/plugins/weather-icon/css/weather-icons.min.css" rel="stylesheet">
	<link href="assets2/plugins/owl-carousel/owl.carousel.min.css" rel="stylesheet">
	<link href="assets2/plugins/owl-carousel/owl.theme.min.css" rel="stylesheet">
	<link href="assets2/plugins/owl-carousel/owl.transitions.min.css" rel="stylesheet">
	<link href="assets2/plugins/morris-chart/morris.min.css" rel="stylesheet">
	<link href="assets2/plugins/c3-chart/c3.min.css" rel="stylesheet">
	<link href="assets2/plugins/slider/slider.min.css" rel="stylesheet">
	<link href="assets2/plugins/salvattore/salvattore.css" rel="stylesheet">
	<link href="assets2/plugins/toastr/toastr.css" rel="stylesheet">
	<link href="assets2/plugins/switch/dist/css/bootstrap3/bootstrap-switch.css" rel="stylesheet">
</head>
<body class="tooltips" style="background-color: #F7F9FA">
	...
	<div class="page-content hsl-toggle" style="background: none repeat scroll 0% 0% rgb(247, 249, 250); padding-bottom: 45px;">
		<div class="container-fluid"  style="padding-left: 10px; padding-right: 10px;">
			<div class="the-box no-border" style="background: none repeat scroll 0% 0% rgb(251, 251, 251); margin-bottom: 0px; padding-bottom: 0px; padding-right: 0px; padding-left: 0px; margin-left: -10px; margin-right: -10px;">
				...
				<h2 class="page-heading text-center" style="margin-top: 0px; margin-bottom: 0px;">Selamat Datang {{ ucfirst(session()->get('role')) }}</h2>
...
<script type='text/javascript' src='assets2/jquery-1.8.0.min.js'></script>
...
<script src='assets2/plugins/retina/retina.min.js'></script>
<script src='assets2/plugins/nicescroll/jquery.nicescroll.js'></script>
<script src='assets2/plugins/slimscroll/jquery.slimscroll.min.js'></script>
<script src='assets2/plugins/backstretch/jquery.backstretch.min.js'></script>
<script src="assets2/plugins/sw-bootstrap/js/highlight.js"></script>
<script src="assets2/plugins/sw-bootstrap/js/bootstrap-switch.js"></script>
<script src='assets2/plugins/icheck/icheck.min.js'></script>
<script src='assets2/plugins/chosen/chosen.jquery.min.js'></script>
<script src='assets2/plugins/magnific-popup/jquery.magnific-popup.min.js'></script>
<script src='assets2/plugins/prettify/prettify.js'></script>
<script src='assets2/plugins/timepicker/bootstrap-timepicker.js'></script>
<script src='assets2/plugins/newsticker/jquery.newsTicker.min.js'></script>
<script src='assets2/plugins/mask/jquery.mask.min.js'></script>
<script src='assets2/plugins/markdown/bootstrap-markdown.js'></script>
<script src='assets2/plugins/markdown/to-markdown.js'></script>
<script src='assets2/plugins/markdown/markdown.js'></script>
<script src='assets2/plugins/datatable/js/jquery.dataTables.min.js'></script>
<script src='assets2/plugins/datatable/js/bootstrap.datatable.js'></script>
<script src='assets2/plugins/validator/bootstrapValidator.min.js'></script>
<script src='assets2/plugins/datepicker/bootstrap-datepicker.js'></script>
<script src='assets2/plugins/summernote/summernote.min.js'></script>
<script src='assets2/plugins/slider/bootstrap-slider.js'></script>
<script src='assets2/plugins/skycons/skycons.js'></script>
<script src='assets2/plugins/owl-carousel/owl.carousel.min.js'></script>
<script src='assets2/plugins/toastr/toastr.js'></script>
<script src='assets2/plugins/fullcalendar/lib/jquery-ui.custom.min.js'></script>
<script src='assets2/plugins/fullcalendar/fullcalendar/fullcalendar.min.js'></script>
<script src='assets2/js/full-calendar.js'></script>
<script src='assets2/plugins/jquery-knob/jquery.knob.js'></script>
<script src='assets2/plugins/jquery-knob/knob.js'></script>
<script src='assets2/plugins/flot-chart/jquery.flot.js'></script>
<script src='assets2/plugins/flot-chart/jquery.flot.tooltip.js'></script>
<script src='assets2/plugins/flot-chart/jquery.flot.resize.js'></script>
<script src='assets2/plugins/flot-chart/jquery.flot.selection.js'></script>
<script src='assets2/plugins/flot-chart/jquery.flot.stack.js'></script>
<script src='assets2/plugins/flot-chart/jquery.flot.time.js'></script>
<script src='assets2/plugins/flot-chart/example.js'></script>
<script src='assets2/plugins/morris-chart/raphael.min.js'></script>
<script src='assets2/plugins/morris-chart/morris.min.js'></script>	
<script src='assets2/plugins/c3-chart/d3.v3.min.js' charset='utf-8'></script>
<script src='assets2/plugins/c3-chart/c3.min.js'></script>
<script src='assets2/plugins/easypie-chart/easypiechart.min.js'></script>
<script src='assets2/plugins/easypie-chart/jquery.easypiechart.min.js'></script>
<script src='assets2/plugins/switch/dist/js/bootstrap-switch.js'></script>
<script src='assets2/js/apps.js'></script>
<script src='assets2/js/online.js'></script>
